...
public class LoggingEventController extends BaseController<LoggingEvent, Long> {
    ...
    @MenuData("Configuration Management: The system records : Exception Logging")
    @RequiresPermissions("Configuration Management: The system records : Exception Logging")
