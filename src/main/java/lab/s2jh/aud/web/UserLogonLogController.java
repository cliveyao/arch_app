...
@MetaData("Configuration Management: The system records : Records Management Account")
@Controller
...
public class UserLogonLogController extends BaseController<UserLogonLog, Long> {
    ...
    @MenuData("Configuration Management: The system records : Account Records")
    @RequiresPermissions("Configuration Management: The system records : Account Records")
