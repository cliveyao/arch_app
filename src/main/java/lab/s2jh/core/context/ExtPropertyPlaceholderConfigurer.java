...
/**
 *Extension of the standard PropertyPlaceholderConfigurer the properties file configuration 
 *parameter information in the Global Map variable facilitate other key-value interface to 
...
public class ExtPropertyPlaceholderConfigurer extends PropertyPlaceholderConfigurer {
    ...
    protected void processProperties(ConfigurableListableBeanFactory beanFactoryToProcess, Properties props) throws BeansException {
        ...
        // Cloud server environment generally do not support multicast communication , RMI cluster requires peerDiscovery = manual mode
        // Dynamic entity object to access information manually assembled multicast address notification message string
        ...
        if (StringUtils.isNotBlank(rmiServers)) {
         ...
         // Get the current host name , add a follow-up to the current host RMI Manual exclude list , otherwise it will cause the current cache at the same time also remove empty cause loss of cached data access
