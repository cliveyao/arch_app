...
public class MybatisRedisCache implements Cache {
   ...
   // Cache is used to identify the global version , usually in an updated version of the application to 
    //automatically update this value before and after the update application uses its own version of the 
    //cached data to avoid type conversion exception
