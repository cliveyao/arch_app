...
public class DatabaseDataInitializeExecutor {
    ...
    public void initialize() {
        ...
        // Development model must be allowed to delete a database
     ...
     // Clear the release of all foundation and operation of analog data cache
        entityManager.clear();
    }

    /**
     * Object initialization self-energizing start value
     */
