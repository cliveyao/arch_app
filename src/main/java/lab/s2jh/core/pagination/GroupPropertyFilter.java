...
/**
 * For jqGrid custom advanced search criteria packaged combination of conditions
 */
public class GroupPropertyFilter {
    ...
    */
    ...
    /**
     * Analyzing currently does not provide any default query parameters
     * General for parent-child structure according to the type of data without additional 
     * parameters determine parent == null query criteria
     * @return
     */
    public boolean isEmptySearch() {
        ...
        for (PropertyFilter filter : mergeFileters) {
        	...
        	// FETCH type is not a valid query, ignored
    ...
    /**
     *Map data is converted to the structure of the Key-Value
     * @return
     */
    public Map<String, Object> convertToMapParameters() {
        ...
        for (PropertyFilter propertyFilter : propertyFilters) {
         ...
         // Set The partition is converted to _ form for the references in MyBatis
    ...
    /**
     * Conversion Query collection is PropertyFilter, for communication to MyBatis as a dynamic query parameters
     * Note Restrictions: consider only the most commonly used one -level adjustment combined query processing
     *  does not support complex multi- level nested hierarchical queries
     * @return 
     */
