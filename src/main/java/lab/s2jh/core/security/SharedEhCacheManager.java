...
/**
 *Reference implementations @see org.springframework.cache.ehcache.EhCacheManagerFactoryBean
 * The @see org.apache.shiro.cache.ehcache.EhCacheManager implement a shared cache management mode Shiro
 * Since the reference category in the init method statement for the final result can not be directly overwritten , 
 * it can only change the source code directly on their
 */
