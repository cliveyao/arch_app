...
public class IPAddrFetcher {
    ...
    /**
     *Get client IP address , proxy server support
     * @param request
     * @return
     */
    public static String getRemoteIpAddress(HttpServletRequest request) {
     ...
     // Match Case , guaranteed no matter how Nginx proxy configuration parameters, the system can normally obtain the proxy IP
